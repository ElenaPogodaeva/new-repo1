import { getCars, getCar, createCar, updateCar, deleteCar} from 'index.js'

//const {items: cars, count: carsCount} = await getCars(1);

const {items: cars, count: carsCount} = await getCars([{key: '_page', value: 1}, {key: '_limit', value: 2}]);
...
<button class="button select-button" id="select-car">Select</button>
<button class="button remove-button" id="remove-car">Remove</button>
  ...
  export const render = async () => {
    ...
    <div class="" id="garage-view">
      ...
      <form class="form" id="update-form">
        ...
        <input class="color" id="update-color" name="color" type="color" value="#fff">
